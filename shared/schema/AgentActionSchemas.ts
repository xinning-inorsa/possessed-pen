...
// Apply Mermaid Action
export const ApplyMermaidAction = z
	.object({
		_type: z.literal('apply_mermaid'),
		mermaid: z.string(),
		intent: z.string(),
	})
	.meta({
		title: 'Apply Mermaid',
		description:
			'The AI emits a Mermaid flowchart string. The client renders it with createMermaidDiagram — never use freehand coordinates.',
	})

export type ApplyMermaidAction = z.infer<typeof ApplyMermaidAction>
