...
export interface BedrockModelDefinition extends BaseAgentModelDefinition {
	provider: 'bedrock'
	thinking: AnthropicThinking
	effort?: AnthropicEffort
}
...
export const AGENT_MODEL_DEFINITIONS = {
	// Amazon Bedrock (Claude) — default for possessed-pen
...
export const DEFAULT_MODEL_NAME: AgentModelName = 'claude-sonnet-bedrock'
