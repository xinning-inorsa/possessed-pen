// @ts-nocheck — worker shim: same as SDK client but uses fetch/WebSocket runtimeConfig.browser
...
import { defaultTranscribeStreamingHttpAuthSchemeParametersProvider, resolveHttpAuthSchemeConfig, } from '@aws-sdk/client-transcribe-streaming/dist-es/auth/httpAuthSchemeProvider'
import { resolveClientEndpointParameters, } from '@aws-sdk/client-transcribe-streaming/dist-es/endpoint/EndpointParameters'
import { getRuntimeConfig as __getRuntimeConfig } from '@aws-sdk/client-transcribe-streaming/dist-es/runtimeConfig.browser.js'
import { resolveRuntimeExtensions } from '@aws-sdk/client-transcribe-streaming/dist-es/runtimeExtensions'
